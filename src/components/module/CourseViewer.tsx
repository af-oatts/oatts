...
function GetFirstIncompleteContentId(states: ContentState[]): string | undefined {
...
export default function CourseViewer({ contents, paNumber, onEverythingCompleted }: { contents: StatelessCourseContent[], paNumber?: string, onEverythingCompleted?: () => void }) {
  ...
  function loadNext() {
    if (states.length < 1) {
      console.error('Attempted to load next incomplete or default content, but states array is empty! This could be because states haven\'t loaded yet or because there are no contents in this module.');
    }
